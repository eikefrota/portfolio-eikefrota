...
const ProjectsDesktopGallery = memo(function ProjectsDesktopGallery({
    ...
    return (
        <div className={`group/shell relative flex w-full flex-col overflow-hidden p-3 sm:p-4 ${viewportShell}`}>
            <span
            ...
            <div ref={viewportRef} className="relative min-h-0 w-full flex-1 overflow-hidden">
                <div ref={trackRef} className="absolute inset-0 flex flex-col gap-5 will-change-transform sm:gap-6 lg:gap-8">
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            mm.add(DESKTOP_MQ, () => {
                ...
                const pinScrollPx = () => Math.round(window.innerHeight * (1.85 + FEATURED_COUNT * 0.42));
