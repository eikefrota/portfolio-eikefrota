        ...
        <div className="relative z-10 mx-auto h-full min-h-0 w-full max-w-[1920px] px-4 sm:px-6 md:h-auto md:px-10 lg:px-14 xl:px-20">
          ...
          <HeroMotionRoot className="md:hidden flex h-full flex-col justify-center gap-4 py-4 sm:py-6">
            <HeroEnterSplitRow
              left={
                <div className="font-mono uppercase tracking-[0.28em] text-[10px] text-foreground/70">
                  <div className="whitespace-nowrap text-foreground/55 tracking-[0.26em]">
                    {content.hero.topNoteLine1} {content.hero.topNoteLine2}
                  </div>
                </div>
              }
            ...
            <HeroEnterBlock drift="right">
              <div className="text-right">
                <p className="text-[11px] font-mono uppercase tracking-[0.22em] text-foreground/72">
                  {content.hero.bodyLine1}
                  <br />
                  {content.hero.bodyLine2}
                </p>
                <div className="mt-2 text-[10px] font-mono uppercase tracking-[0.24em] text-foreground/55">
                  {content.hero.availabilityLine1}
                  <br />
                  {content.hero.availabilityLine2}
                </div>
              </div>
            </HeroEnterBlock>

            <HeroEnterBlock drift="right">
              <div className="text-right text-foreground font-black uppercase leading-[0.88] tracking-[-0.06em] text-[clamp(3.1rem,13vw,5.2rem)]">
            ...
            <HeroEnterBlock>
              <div className="text-right text-[10px] font-mono uppercase tracking-[0.26em] text-foreground/55">
                {new Date().getFullYear()} {content.hero.yearLabel}
              </div>
            </HeroEnterBlock>

            <HeroEnterBlock>
              <div className="grid grid-cols-12 items-start gap-2">
                <div className="col-span-1 text-foreground/70 text-lg leading-none select-none">
                  <span aria-hidden="true">-&gt;</span>
                </div>
                <div className="col-span-11">
                  <div className="whitespace-nowrap text-[10px] font-mono uppercase tracking-[0.28em] text-foreground/70">
                    {content.hero.locationLine1} {content.hero.locationLine2} {content.hero.locationLine3}
                  </div>
                </div>
              </div>
            </HeroEnterBlock>
          ...
          <HeroMotionRoot className="hidden flex-col gap-6 py-6 md:flex md:justify-start md:gap-8 md:py-8 lg:gap-10 lg:py-10">
            ...
            <div className="grid grid-cols-12 items-start gap-x-6 gap-y-10">
              ...
              <HeroEnterBlock
                className="col-span-12 md:col-span-7 md:order-1 md:text-left"
                drift="left"
              >
            ...
            <div className="grid grid-cols-12 items-start gap-x-6 gap-y-8">
              <HeroEnterBlock
                className="col-span-12 md:col-span-5 md:order-2"
                drift="right"
              >
                <div className="mb-6 max-w-104 md:ml-auto md:text-right">
                  <p className="text-[11px] font-mono uppercase tracking-[0.22em] text-foreground/72">
                    {content.hero.bodyLine1}
                    <br />
                    {content.hero.bodyLine2}
                ...
                <div className="text-foreground font-black uppercase leading-[0.88] tracking-[-0.05em] text-[clamp(3.4rem,6.7vw,6.4rem)] md:text-right">
                  {SITE_IDENTITY.firstName}
                  <br />
                  {SITE_IDENTITY.lastName}
                </div>
              ...
              <HeroEnterBlock
                className="col-span-12 md:col-span-7 md:order-1"
                drift="left"
              >
