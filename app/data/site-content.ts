...
const siteContentByLocale: Record<SiteLocale, LocaleContent> = {
  en: {
    ...
    testimonials: {
      ...
      titleLine1: "How",
      titleLine2: "I Work",
      note: "The principles that guide how I collaborate, build, and ship work in real product contexts.",
      ratingLabel: "signals",
      items: [
        {
          name: "Context",
          role: "How I start",
          company: "Understanding first",
          badge: "CT",
          content:
            "I get up to speed quickly, respect the existing codebase, and make changes that move the product without creating noise around it.",
          rating: 5,
        },
        {
          name: "Communication",
          ...
          badge: "CM",
          content:
            "I keep communication direct and clear so discussions, tradeoffs, and implementation stay aligned from briefing to delivery.",
          rating: 5,
        },
        {
          name: "Execution",
          role: "How I deliver",
          company: "Shipping work",
          badge: "EX",
          content:
            "I work well in iteration-heavy environments, handle fixes without friction, and keep momentum even when priorities change mid-sprint.",
          rating: 5,
        },
        {
          name: "Ownership",
          role: "How I contribute",
          company: "Final quality",
          badge: "OW",
          content:
            "I care about usability, consistency, and the final result, not just closing a task and moving on.",
          rating: 5,
        },
      ],
    },
    ...
    footer: {
      ...
      nav: [
        ...
        { label: "How I Work", href: "#testimonials" },
  ...
  "pt-BR": {
    ...
    testimonials: {
      label: "Abordagem",
      titleLine1: "Como",
      titleLine2: "eu trabalho",
      note: "Os princípios que guiam a forma como eu colaboro, construo e entrego em contextos reais de produto.",
      ratingLabel: "sinais",
      items: [
        {
          name: "Contexto",
          role: "Como eu começo",
          company: "Entendimento primeiro",
          badge: "CT",
          content:
            "Eu ganho contexto rápido, respeito o código existente e faço mudanças que movem o produto sem gerar ruído ao redor.",
          rating: 5,
        },
        {
          name: "Comunicação",
          role: "Como eu me alinho",
          company: "Alinhamento com produto",
          badge: "CM",
          content:
            "Mantenho a comunicação direta e clara para que discussões, trade-offs e implementação sigam alinhados do briefing até a entrega.",
          rating: 5,
        },
        {
          name: "Execução",
          role: "Como eu entrego",
          company: "Ritmo de entrega",
          badge: "EX",
          content:
            "Trabalho bem em ambientes com muita iteração, resolvo ajustes sem atrito e mantenho o ritmo mesmo quando as prioridades mudam no meio da sprint.",
          rating: 5,
        },
        {
          name: "Responsabilidade",
          role: "Como eu contribuo",
          company: "Qualidade final",
          badge: "OW",
          content:
            "Eu me importo com usabilidade, consistência e qualidade do resultado final, não apenas em concluir uma tarefa e seguir adiante.",
          rating: 5,
        },
      ],
    },
    ...
    footer: {
      ...
      nav: [
        ...
        { label: "Como eu trabalho", href: "#testimonials" },
